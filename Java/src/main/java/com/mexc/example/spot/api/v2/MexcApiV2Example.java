package com.ourbit.example.spot.api.v2;
...
import com.ourbit.example.common.SignatureUtil;
import com.ourbit.example.spot.api.v2.pojo.*;
...
@Slf4j
public class OurbitApiV2Example {
    private static final int CONN_TIMEOUT = 20;
    private static final int READ_TIMEOUT = 20;
    private static final int WRITE_TIMEOUT = 20;

    private static final String REQUEST_HOST = "https://www.ourbit.com";

    private final String secretKey;
    private final String accessKey;

    public OurbitApiV2Example(String secretKey, String accessKey) {
