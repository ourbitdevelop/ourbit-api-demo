...
public class Ticker24hr {
    public static com.ourbit.example.spot.api.v3.pojo.Ticker24hr ticker24hr(Map<String, String> params) {
        return MarketDataClient.get("/api/v3/ticker/24hr", params, new TypeReference<com.ourbit.example.spot.api.v3.pojo.Ticker24hr>() {
        });
    }
