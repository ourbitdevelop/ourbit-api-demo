...
{
  public sealed class OurbitService
  {
    ...
    public OurbitService(string apiKey, string apiSecret, string baseUrl, HttpClient httpClient)
    {
      this.apiKey = apiKey;
    ...
    private async Task<string> SendAsync(string requestUri, HttpMethod httpMethod, object content = null)
    {
      ...
      {
        request.Headers.Add("X-OURBIT-APIKEY", this.apiKey);
